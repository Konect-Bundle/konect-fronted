...
import ProductItemBlock from "@/components/Inc/ProductItemBlock";
...
import { loginRoute, productItemRoute } from "@/core/config/routes";
import { IntentInterface } from "@/core/interfaces/appInterfaces";
import { KoGadgetItem } from "@/core/models/KoGadgetItem";
import { OrderSchema } from "@/core/schemas/orderSchema";
...
export default function KwidgetItemPage({
    ...
    // >(null);
    const initialValues: CustomConfigInterface = {
        name: "",
        firstname: "",
        title: "",
        quantity: 1,
...
//                                     e.target.files![0],
//                                 );
//                                 formProps.setFieldValue("withCustomLogo", true);
//                                 // if (file) {
...
//                         <div className="mt-3 bg-white border-2 border-dashed flex flex-col items-center py-4 cursor-pointer text-gray-500" onClick={handleAddCustomLogo}>
...
//                                                     {file.name}
//                                                 </p>
//                                                 <p className="text-xs text-gray-500 dark:text-neutral-500">{(file.size / (1024 * 1000)).toFixed(2)}MB</p>
//                                             </div>
//                                         </div>
...
//                                     onClick={() => {
//                                         if (formProps.values.quantity > 1) {
//                                             formProps.setFieldValue("quantity", formProps.values.quantity - 1)
//                                         }
//                                     }}
//                                 >
//                                     <TbMinus />
...
//                                     onClick={() => {
//                                         var newQty =
//                                             formProps.values.quantity + 1;

//                                         formProps.setFieldValue("quantity", newQty)
//                                     }}
//                                 >
//                                     <TbPlus />
//                                 </span>
