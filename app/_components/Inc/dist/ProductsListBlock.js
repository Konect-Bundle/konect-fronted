...
function ProductsListBlock(_a) {
    ...
    react_1.useEffect(
        function () {
            ...
            data.map(function (gadget) {
                var g = new KoGadgetItem_1.KoGadgetItem(
    ...
    return react_1["default"].createElement(
        ...
        react_1["default"].createElement(
            "div",
            { className: "flex space-x-3 items-center pb-6" },
            react_1["default"].createElement(
                "div",
                { className: "w-max space-x-1" },
                react_1["default"].createElement(
                    flowbite_react_1.Badge,
                    {
                        size: "sm",
                        icon: tb_1.TbFilterFilled,
                        href: "#",
                        className: "px-3 py-2",
                        color: "dark",
            ...
            react_1["default"].createElement(
                ...
                {
                    label: functions_1.ucfirst(filter),
                    theme: dropdown_1.customDropdownTheme,
                    inline: true,
                },
                gadgetFilters.map(function (gadgetFilter, index) {
                    return react_1["default"].createElement(
                        ...
                        functions_1.ucfirst(gadgetFilter),
                    );
                }),
            ),
        ),
                ...
                !isLoading
                    ? gadgets != null && gadgets.length == 0
                        ? react_1["default"].createElement(
                              ...
                              react_1["default"].createElement(
                                  NoResultFound_1["default"],
                                  null,
                              ),
                          )
                        : gadgets === null || gadgets === void 0
                          ? void 0
                          : gadgets.map(function (gadget, index) {
                                console.log(
                                    (
                                ...
                                return react_1["default"].createElement(
                                    "span",
                                    {
                                        key: index,
                                        className:
                                            "mx-auto sm:mr-0 group cursor-pointer lg:mx-auto transition-all duration-500 rounded-xl p-3",
                                    },
                                    react_1["default"].createElement(
                                        "div",
                                        {
                                            className:
                                                "bg-white border rounded-3xl overflow-hidden border-noir-medium/25",
                                        },
                                        react_1["default"].createElement(
                                            image_1["default"],
                                            {
                                    ...
                                    react_1["default"].createElement(
                                        ...
                                        react_1["default"].createElement(
                                            ...
                                            react_1["default"].createElement(
                                                ...
                                                {
                                                    className:
                                                        "font-semibold text-md leading-8 text-black transition-all duration-500 group-hover:text-gray-800",
                                                },
                                                functions_1.ucfirst(
                                                    gadget.color.name,
                                                ) +
                                            ...
                                            react_1["default"].createElement(
                                                ...
                                                react_1[
                                                    ...
                                                    {
                                                        className:
                                                            "font-semibold text-md leading-8 text-gray-700",
                                                    },
                                                    "$",
                                                    gadget.price,
                                                ),
                    ...
                    : react_1["default"].createElement(
                          ...
                          react_1["default"].createElement(
                              ...
                              react_1["default"].createElement(
                                  ...
                                  {
                                      className:
                                          "flex space-x-2 items-center justify-between px-4",
                                  },
                                  react_1["default"].createElement(
                                      TextSkeleton_1["default"],
                                      { className: "w-1/3", height: 4 },
                                  ),
                                  react_1["default"].createElement(
                                      TextSkeleton_1["default"],
                                      { className: "w-24", height: 12 },
                                  ),
                              ),
                          ),
                          react_1["default"].createElement(
