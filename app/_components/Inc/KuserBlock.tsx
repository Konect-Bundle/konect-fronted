        ...
        <div className="h-screen py-4">
            ...
            <div className="grid grid-cols-12 gap-2 h-full w-screen bg-gray-100">
                <div className="flex flex-col lg:col-span-4 sm:col-span-6 col-span-12 px-4">
                    <div
                        className="relative py-4 flex flex-col items-center justify-start mt-32 mb-2 h-full bg-white rounded-lg space-y-3 md:space-y-6 px-6 border">
              ...
              {isLoading ? (
                  ...
                  <span className="rounded-xl max-w-52 min-h-52 overflow-hidden flex justify-center items-center">
                    ...
                    />{" "}
                        ...
                        <div>
              <span
                  className="my-1 text-gray-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded flex items-center bg-gray-50 border">
                ...
                <div
                    className="border my-2 bg-white lg:col-span-8 sm:col-span-6 col-span-12 flex flex-col space-y-8  px-8 rounded-lg">
                    {isLoading ? (
                        <span>
