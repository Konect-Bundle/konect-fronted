...
var VcardEditor = function (_a) {
    ...
    var initialValues = {
        ...
        location: {
            state: vcard.location.state
                ? functions_1.ucfirst(vcard.location.state)
                : "",
    ...
    return react_1["default"].createElement(
        LoadingLayout_1["default"],
        { isLoading: isLoading },
        react_1["default"].createElement(
            formik_1.Formik,
            { initialValues: initialValues, onSubmit: handleSubmitForm },
            function (formProps) {
                return react_1["default"].createElement(
                    formik_1.Form,
                    ...
                    react_1["default"].createElement(
                        "div",
                        { className: "bg-white rounded-lg mb-6 w-full" },
                        react_1["default"].createElement(
                            flowbite_react_1.Tabs,
                            {
                                "aria-label": "Tabs with icons",
                                theme: tabs_1.customTabsTheme,
                                variant: "underline",
                            },
                            react_1["default"].createElement(
                                flowbite_react_1.Tabs.Item,
                                {
                                    active: true,
                                    title: Ttext("general_infos"),
                                    icon: tb_1.TbUserQuestion,
                                },
                                react_1["default"].createElement(
                                    "div",
                                    {
                                        className:
                                            "flex md:flex-row md:justify-start justify-center flex-col items-center md:space-x-8 space-x-0 px-8 pb-8 pt-5",
                                    },
                                    react_1["default"].createElement(
                                        "div",
                                        {
                                            className:
                                                "w-40 h-40 flex justify-center rounded-xl overflow-hidden",
                                        },
                                    ...
                                    react_1["default"].createElement(
                                        ...
                                        react_1["default"].createElement(
                                            ...
                                            react_1["default"].createElement(
                                                ...
                                                {
                                                    className:
                                                        "cursor-pointer rounded-md flex items-center space-x-1 bg-gray-50 text-gray-500 w-max px-4 py-1 border border-gray-300/40 hover:text-gray-600 transition-colors",
                                                },
                                                react_1[
                                                    "default"
                                                ].createElement(
                                                ...
                                                react_1[
                                                    ...
                                                    flowbite_react_1.Label,
                                                    {
                                                        className:
                                                            "text-gray-500 font-normal cursor-pointer hover:text-gray-600 transition-colors",
                                                        htmlFor:
                                            ...
                                            react_1["default"].createElement(
                                                flowbite_react_1.FileInput,
                                                {
                                                    className: "hidden",
                                                    accept: ".jpg,.jpeg,.png",
                                                    theme: form_1.customFileInputTheme,
                                                    color: "gray",
                                ...
                                react_1["default"].createElement(
                                    "div",
                                    { className: "px-8 pb-8 md:pt-5 pt-2" },
                                    react_1["default"].createElement(
                                        "h2",
                                        {
                                            className:
                                                "pb-6 font-semibold text-xl ",
                                        },
                                        Ttext("general_infos"),
                                    ),
                                    react_1["default"].createElement(
                                        VcardGeneralForm_1["default"],
                            ...
                            react_1["default"].createElement(
                                ...
                                react_1["default"].createElement(
                                    ...
                                    react_1["default"].createElement(
                                        ...
                                        {
                                            className:
                                                "pb-6 text-gray-300/85 text-sm mt-2 font-light",
                                        },
                                        Ttext("should_see"),
                                    ),
                                    react_1["default"].createElement(
                                        VcardConfigsForm_1["default"],
                                        null,
                                    ),
                                ),
                            ),
                    ...
                    react_1["default"].createElement(
                        ...
                        react_1["default"].createElement(tb_1.TbEdit, {
                            className: "text-lg",
                        }),
                        react_1["default"].createElement(
                            "span",
