...
var VcardConfigsForm = function (_a) {
    ...
    return react_1["default"].createElement(
        ...
        react_1["default"].createElement(
            ...
            {
                className:
                    "grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4",
            },
            react_1["default"].createElement(
                "div",
                { className: "h-14" },
                react_1["default"].createElement(
                    InputWithLabel_1["default"],
                    {
                        isInline: true,
                            ...
                            return react_1["default"].createElement(
                                flowbite_react_1.Popover,
                                {
                                    ...
                                    content: react_1["default"].createElement(
                                        ...
                                        {
                                            className:
                                                "flex-col space-y-2 items-center bg-white p-2 rounded-lg",
                                        },
                                        react_1["default"].createElement(
                                            react_colorful_1.HexColorPicker,
                                            {
                                                color: field.value,
                                        ...
                                        react_1["default"].createElement(
                                            flowbite_react_1.TextInput,
                                            {
                                                theme: form_1.customTextInputTheme,
                                                value: field.value,
                                                onChange: function (e) {
                                                    return setFieldValue(
                                                        "config.configTheme.primaryColor",
                                ...
                                react_1["default"].createElement(
                                    ...
                                    {
                                        className:
                                            "py-1 px-1 border rounded-md border-gray-300/45 h-max",
                                    },
                                    react_1["default"].createElement(
                                        "div",
                                        {
                                            style: {
                                                ...
                                                color: functions_1.generateColorVariants(
                                                    field.value,
                                                ).text,
                                            },
                                            className:
                                                "w-full h-10 rounded-sm px-2 flex justify-center items-center",
                                        },
                                        field.value,
                                    ),
                                ),
