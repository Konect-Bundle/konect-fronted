...
var KuserHeader = function (props) {
    ...
    return react_1["default"].createElement(
        "div",
        { className: "fixed z-40 top-0 left-0 w-screen flex " },
        react_1["default"].createElement(
            flowbite_react_1.Alert,
            {
                theme: alert_1.customAlertTheme,
                color: "dark",
                className: !showAlert
                    ? "hidden "
                    : "" + "w-full rounded-none p-0",
            ...
            react_1["default"].createElement(
                ...
                {
                    className:
                        "flex justify-between items-center p-3 text-gray-100  space-x-3 w-full",
                },
                react_1["default"].createElement(
                    "div",
                    {
                        className:
                            "items-center text-gray-100 flex space-x-2 rounded-md md:text-md text-sm",
                    },
                    react_1["default"].createElement(
                        "svg",
                        {
                ...
                react_1["default"].createElement(
                    "div",
                    { className: "md:space-x-4 space-x-2 flex items-center" },
                    react_1["default"].createElement(
                        link_1["default"],
                        {
