...
export default function Header(props: IAppProps) {
    ...
    return (
        <Navbar fluid rounded theme={customNavbarTheme}>
            <div
                className="flex md:flex-nowrap space-x-3 flex-nowrap justify-between mx-auto md:py-2 py-1 w-full md:items-center items-start">
                <NavbarBrand href={homeRoute.path}>
                    <div
                        className="md:h-[100%] h-[72px] bg-gray-900 rounded-xl py-3 px-6 flex items-center justify-center">
                        <Image
                            width={500}
                            height={500}
                ...
                <div
                    ...
                    <div className="ml-4 flex md:order-2 md:space-x-4 space-x-3">
                        <Link href={productsRoute.path}>
                            <Button theme={customButtonTheme} color="primary" size="md">{tAction("get_card")}</Button>
                        </Link>

                        <Link href={loginRoute.path}>
                            <Button theme={customButtonTheme} color="primary-light" size="md">{tAction("login")}</Button>
