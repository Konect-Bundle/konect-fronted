...
export default function OrderHistoryPage(props: OrderHistoryProps) {
    ...
    return (
        user && (
            <section className="bg-white py-8 antialiased rounded-lg dark:bg-gray-900 md:py-16">
                            ...
                            <div className="divide-y divide-gray-200 dark:divide-gray-700">
                                {user.orders?.map((order, i) => (
                                    <div
                                        ...
                                        key={i}
                                    >
                                        <dl className="w-1/2 sm:w-1/4 text-clip overflow-hidden lg:flex-1">
