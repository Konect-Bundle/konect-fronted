...
interface MembersListCompanyPageProps {
    slug: string;
}

export default function MembersListCompanyPage({
    slug
}: MembersListCompanyPageProps) {
                                ...
                                <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                        ...
                                        <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                                            {
                                                currentCompany?.members?.map(member => <tr>
                                                    <td className="size-px whitespace-nowrap">
                                                        <div className="ps-6 py-3">
                                                            <label htmlFor="hs-at-with-checkboxes-1" className="flex px-2">
                                                                <input
                                                                    type="checkbox"
                                                                    className="shrink-0 border-gray-300 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                                        ...
                                                        <div className="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                            <div className="flex items-center gap-x-3">
                                                                ...
                                                                <div className="grow">
                                                                    ...
                                                                    {member.companyEmail ?? "test@example.com"}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
