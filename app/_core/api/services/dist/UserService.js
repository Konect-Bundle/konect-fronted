    ...
    UserService.buildObjectParser = function (data) {
            ...
            data.data.konects.forEach(function (konect) {
                konects.push(
                    new Konect_1.Konect(
                        ...
                        konect.created_at,
                        JSON.parse(konect.ko_user_info),
                    ),
                );
            });
        }
        ...
        if (data.data.gadgets) {
            data.data.gadgets.forEach(function (gadget) {
                ...
                gadgets.push(
                    new KoGadgetItem_1.KoGadgetItem(
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            functions_1.fetchData("/api/user/uuid/" + uuid),
                        ];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            functions_1.fetchData(
                                "/api/auth/login",
                                object_to_formdata_1.serialize({
                                    email: email,
                                    password: password,
                                }),
                                {},
