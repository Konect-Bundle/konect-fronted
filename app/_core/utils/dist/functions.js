...
exports.actionValidityHasExpired = exports.generateColorVariants = exports.stringToEnum = exports.generateVCard = exports.formatNumber = exports.dataURLToFile = exports.dataURLToBlob = exports.convertYouTubeLinkToEmbed = exports.intent_processor = exports.client_token = exports.ucwords = exports.ucfirst = exports.esser = void 0;
...
function intent_processor(intentData, token) {
    return __awaiter(this, void 0, Promise, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(intentData.from == routes_1.productItemRoute.name)) return [3 /*break*/, 2];
                    return [4 /*yield*/, PaymentService_1.PaymentService.makePayment(intentData.data.file, intentData.data.code, intentData.data.name, intentData.data.familyName, intentData.data.companyName, intentData.data.qty, token, intentData.data.fileName)];
                case 1: return [2 /*return*/, (_a.sent()).data.url];
...
function convertYouTubeLinkToEmbed(url) {
    ...
    var videoIdMatch = url.match(/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i);
...
function actionValidityHasExpired(dateFrom, expirationMinutes) {
    if (expirationMinutes === void 0) { expirationMinutes = 60; }
    // Convertit la date de création en timestamp
    var createAsTimestamp = new Date(dateFrom).getTime();
    ...
    var timeDifference = currentTimestamp - createAsTimestamp;
    // Vérifie si le temps écoulé dépasse le temps d'expiration
    return timeDifference > expirationMilliseconds;
}
exports.actionValidityHasExpired = actionValidityHasExpired;
