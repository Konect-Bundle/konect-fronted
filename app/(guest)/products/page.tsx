...
import {Breadcrumb, Badge, Button, Dropdown, DropdownItem} from "flowbite-react";
import {productsRoute, productItemRoute} from "@/app/_core/config/routes";
import Image from "next/image";
import Link from "next/link";
import {customButtonTheme} from "@/app/_styles/flowbite/button";
import {TbFilter, TbFilterDown, TbFilterFilled, TbHome, TbHome2, TbHomeFilled, TbShoppingBag} from "react-icons/tb";
                        ...
                        <div className="">
                            <div className="flex space-x-3 items-center pb-6">
                                <div className="w-max space-x-1">
                                    <Badge size="sm" icon={TbFilterFilled} href="#" className="px-3 py-2" color="dark"
                                           theme={customBadgeTheme}>
                                        <span>Filter</span>
                                    </Badge>
                                </div>
                                <Dropdown label={ucfirst(filter)} theme={customDropdownTheme} inline>
                                    {
                                        gadgetFilters.map((gadgetFilter, index) => <Dropdown.Item onClick={() => {
                                            setFilter(gadgetFilter)
                                        }}
                                                                                                  key={index}>{ucfirst(gadgetFilter)}</Dropdown.Item>)
                                    }
                                </Dropdown>
                                    ...
                                    {!isLoading ?
                                        gadgets != null && gadgets.length == 0 ?
                                            ...
                                            gadgets?.map((gadget, index) => {
                                                console.log((ROOT_FILES_URL + gadget.imageURL[0]).toString())
                                                    ...
                                                    <span key={index}
                                                        ...
                                                        <div
                                                            ...
                                                            <Image width={500} height={500}
                                                                   src={ROOT_FILES_URL + gadget.imageURL[0]}
                                                                   alt="face cream image" className=""/>
                                                        </div>
                                                        <div className="mt-5">
                                                            <div className="flex items-center justify-between">

                                                                <h6
                                                                    className="font-semibold text-md leading-8 text-black transition-all duration-500 group-hover:text-gray-800">
                                                                    {ucfirst(gadget.color.name) + ' ' + gadget.name}
                                                                </h6>
                                                                <div className="flex space-x-2 items-center">
                                                                    ...
                                                                    <div className="flex justify-end">
                                                                        ...
                                                                        <Link
                                                                            href={productItemRoute.path + "/" + gadget.code}>
                                            ...
                                            <>
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="flex space-x-2 items-center justify-between px-4">
                                                         <TextSkeleton className="w-1/3" height={4}/>
                                                         <TextSkeleton className="w-24" height={12}/>
                                                    </span>
