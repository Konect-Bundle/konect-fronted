                                        ...
                                        <form>
                                            <div className="grid gap-4">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                    <div>
                                                        <label htmlFor="hs-firstname-contacts-1"
                                                               className="sr-only">{'Your firstname'}</label>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="email" name="hs-email-contacts-1"
                                                ...
                                                <div>
                                                    <label htmlFor="hs-about-contacts-1"
                                                           className="sr-only">{'Message'}</label>
                                                    <textarea id="hs-about-contacts-1" name="hs-about-contacts-1"
                                                              rows={4}
                                                              className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                            ...
                                            <div className="mt-4 grid">
                                                <Button theme={customButtonTheme} color="dark">
                                                    {"Send now"}
                                                </Button>
                                            </div>
                                    ...
                                    <div className="divide-y divide-gray-200">
                                        ...
                                        <div className="flex gap-x-7 py-6">
                                            ...
                                            <div className="grow">
                                                ...
                                                <a href="mailto:customers.support@ikonect.me"
