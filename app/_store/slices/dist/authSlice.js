...
exports.setUser = exports.logout = exports.getCurrentUser = void 0;
...
exports.getCurrentUser = toolkit_2.createAsyncThunk(
    "auth/current",
    function (_, thunkAPI) {
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = cookies_next_1.getCookie(
                            constants_1.AUTH_TOKEN_NAME,
                        );
                    ...
                    case 1:
                        ...
                        return [
                            4 /*yield*/,
                            UserService_1.UserService.getLoggedUser(token),
                        ];
                    case 2:
...
exports.logout = toolkit_2.createAsyncThunk(
    "auth/logout",
    function (_, thunkAPI) {
        return __awaiter(void 0, void 0, void 0, function () {
            var token, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        cookies_next_1.deleteCookie(
                            constants_1.AUTH_TOKEN_NAME,
                        );
                        return [
                            4 /*yield*/,
                            UserService_1.UserService.logout(token),
                        ];
                    case 2:
                        return [2 /*return*/, _a.sent()];
                    case 3:
...
var authSlice = toolkit_1.createSlice({
    ...
    extraReducers: function (builder) {
        builder
            ...
            .addCase(
                exports.getCurrentUser.fulfilled,
                function (state, action) {
                    if (action.payload) {
                        state.currentUser =
                            UserService_1.UserService.buildObjectParser(
                                action.payload,
                            );
                    }
