                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="grid gap-12">
                        <div data-aos="fade-up" data-aos-duration="800">
                            <h2 data-aos="fade-up" data-aos-duration="00"
                        ...
                        <div className="space-y-6 lg:space-y-10">
                            {/*Icon Block*/}
                            <div data-aos="fade-up-right" data-aos-duration="700" className="flex">
                                <svg className="flex-shrink-0 mt-2 size-6 text-gray-800 dark:text-white"
                            ...
                            {/*Icon Block*/}
                            <div data-aos="fade-left" data-aos-duration="700" className="flex">
                            ...
                            {/*Icon Block*/}
                            <div data-aos="fade-up-left" data-aos-duration="700" className="flex">
                                <svg className="flex-shrink-0 mt-2 size-6 text-gray-800 dark:text-white"
                                     xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                     strokeLinejoin="round">
            ...
            bottom-0 start-0 end-0 max-w-xs text-center mx-auto p-6 md:start-auto md:text-start md:mx-0">
                        ...
                        <div className="px-5 py-4 inline-block bg-white rounded-lg md:p-7 dark:bg-neutral-800">
                            ...
                            <div className="md:mt-16">
                                <a className="flex items-center gap-2 text-sm font-medium text-gray-800 hover:text-gray-500 dark:text-white dark:hover:text-neutral-400"
                                   href="#">
