...
export const customTabsTheme: CustomFlowbiteTheme["tabs"] = {
    ...
    tablist: {
        ...
        tabitem: {
            ...
            //         base: "rounded-t-lg",
            //         active: {
            //             on: "bg-gray-50 text-yellow-600 dark:bg-gray-800 dark:text-yellow-500",
            ...
            //         base: "rounded-t-lg",
            //         active: {
            //             on: "active rounded-t-lg border-b-2 border-cyan-600 text-yellow-600 dark:border-cyan-500 dark:text-cyan-500",
